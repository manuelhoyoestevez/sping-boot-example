...
import com.inditex.retail.pricing.prices.infrastructure.rest.spring.api.PriceApi;
...
public class PriceController implements PriceApi {
    ...
    public ResponseEntity<PriceDto> getPrice(Long brandId, Long productId, OffsetDateTime date) {
